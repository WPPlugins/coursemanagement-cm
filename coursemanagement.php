...
/*  Copyright 2010  Jonna TÃ¤rneberg
...
function cm_install() {
	...
	if( $wpdb->get_var( "SHOW TABLES LIKE '$tblCourseParticipant'" ) != $tblCourseParticipant ) {
		$sql = "CREATE TABLE " . $tblCourseParticipant . " (
					...
					FOREIGN KEY (courseparticipant_courseID) REFERENCES " . $tblCourses . "(courseID) ON UPDATE CASCADE ON DELETE CASCADE,
					FOREIGN KEY (courseparticipant_participantID) REFERENCES " . $tblParticipants . "(participantID) ON UPDATE CASCADE ON DELETE CASCADE,
